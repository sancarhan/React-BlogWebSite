...
export const blogCategories = ['Tümü', 'Teknoloji', 'Startup', 'Yaşam Tarzı', 'Finans']
...
export const footer_data = [
      {
          ...
          links: ["Ana Sayfa", "En Çok Satanlar", "Teklifler ve Kampanyalar", "Bize Ulaşın", "Sıkça Sorulan Sorular"]
      },
      {
          title: "Yardıma mı ihtiyacınız var?",
          links: ["Teslimat Bilgileri", "İade ve Geri Ödeme Politikası", "Ödeme Yöntemleri", "Siparişinizi Takip Edin", "Bize Ulaşın"]
      },
      {
